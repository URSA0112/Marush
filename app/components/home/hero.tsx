...
export default function Hero({ dict }: { dict: Dict["hero"] }) {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="relative h-screen overflow-hidden flex items-center justify-center mt-2"
    >
      ...
      {/* Overlays */}
      <div className="absolute inset-0 dark:bg-gradient-to-b dark:from-black/75 via-black/35 to-black" />
      <div className="absolute inset-0 dark:bg-gradient-to-r dark:from-black/50 via-transparent to-transparent" />
      <div className="absolute inset-x-0 bottom-0 h-30 bg-gradient-to-t from-cream to-transparent" />
      ...
      >
        ...
        >
          <a
            href="#accommodations"
            className="px-11 py-4 bg-gold text-black text-[0.68rem] tracking-[0.32em] uppercase font-medium hover:brightness-110 hover:scale-[1.03] hover:shadow-[0_0_32px_rgba(198,164,108,0.45)] rounded-sm transition-all duration-300"
          >
            {dict.cta1}
          </a>
          <a
            href="#services"
            className="px-11 py-4 border border-white/30 text-white/75 text-[0.68rem] tracking-[0.32em] uppercase hover:border-gold hover:text-gold rounded-sm transition-all duration-300"
          >
            {dict.cta2}
          </a>
        </motion.div>
